function Reg()
{
	...
	// insurence Type
	let insuretype=document.getElementById("insuretype").value;
	if(insuretype=="0")
	{
		document.getElementById("insuretypemsg").innerHTML="Please Select Body Type..!";
		return false;
	}
	else
	{
		document.getElementById("insuretypemsg").innerHTML=""; 
	}
